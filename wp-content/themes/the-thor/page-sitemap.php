          ...
          <section class="content<?php fit_content_class(); ?>">
			...
			<div class="sitemap">
              ...
              <!--投稿ページ-->
          	  ...
          	  <!--同一-->
              <h2><?php
				$bsSitemap_postH = get_option( 'fit_bsSitemap_postH' );
				if ( isset( $bsSitemap_postH ) && '' !== $bsSitemap_postH ) {
					echo $bsSitemap_postH;
				} else {
					echo '投稿';
				}
              ?>ページ</h2>
        	  ...
        	  <!--カスタム投稿(custom)-->
          	  ...
          	  <!--同一-->
		  	  <?php
          	  $post_type_object = get_post_type_object('custom');
