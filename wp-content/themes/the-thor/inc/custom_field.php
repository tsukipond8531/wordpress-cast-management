...
if ( is_admin() ) {
	...
	require_once locate_template('inc/custom_field/memo.php');         // メモ用ファイル
}
require_once locate_template('inc/custom_field/category.php'); // カテゴリー拡張用ファイル
require_once locate_template('inc/custom_field/tag.php');      // タグ拡張用ファイル
